...
const simih = async (text) => {
	try {
		...
		return 'Simi no sé de qué estás hablando, ¿un idioma extraño, hermano? '
	}
}
...
const banner = cfonts.render(('Soporte y Aportes|WHATSAPP|BOT'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
