...
ator = 'SUBSCRIBE'
namo = 'Soporte y Aportes BOT*'
cr = "~*SUBSCRIBE:Soporte y Aportes BOT🍁~OWNER:JDMTECH🍁*"
// LOAD JSON
...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	...
	baby.on('credentials-updated', () => {
		...
		info('2', 'Soporte y Aportes* Loading...')
	...
	baby.on('connecting', () => {
		...
		start('2', 'Soporte y Aportes* Connecting...')

	})

	baby.on('open', () => {

		success('2', 'Soporte y Aportes* Connected')
